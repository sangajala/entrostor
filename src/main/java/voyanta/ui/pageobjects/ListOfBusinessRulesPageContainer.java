...
public class ListOfBusinessRulesPageContainer extends voyanta.ui.pagecontainers.abstractVoyataPageContainer {
    ...
    @FindBy(how = How.LINK_TEXT, using = "Mapping Rules")
    public WebElement linkMappingRule;

    @FindBy(how = How.LINK_TEXT, using = "Create Mapping Rule")
