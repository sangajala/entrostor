...
public class ListDataManagerContainer extends abstractVoyataPageContainer  {
  ...
  //Table container
    ...
    private final String deleteAllMsgLoc=".message-list.success";

    public final String deleteAllMsg="Errors and / or warnings are removed";

    public By getdeleteAllMsgBy(){
        return By.cssSelector("deleteAllMsgLoc");
    }
	//-----------------------------------------------------
	// PUBLIC METHODS
	//-----------------------------------------------------
